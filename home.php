...
<html>
    <head>
      ...
      <title>Escuela Republica 616</title>
      <!-- Local Stylesheet -->
                ...
                <div class="row dropdown">
                  <div class="col s6">
                    <select name="carrera" id="carrera_alta"  style="display: block;">
                      ...
                      <option value="a">ingernieria de software</option>
                      <option value="d">principios programacion</option>
                ...
                <div class="row dropdown">
                  <div class="col s6">
                    <select name="carrera" id="carrera_modify" style="display: block;">
                      <option value="0">--Carrera--</option>
                      <option value="a">ingenieria de software</option>
                      <option value="d">principios programacion</option>
                      <option value="i">Infraestructura de la Tecnologia</option>
                    </select>
                  </div>
          ...
          <div class="container">
            <div class="row">
              <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">republica616@gmail.com</p>
              </div>
            </div>
          </div>
          <div class="footer-copyright">
            <div class="container">
              <a class="grey-text text-lighten-4 right">patricio straziuso</a>
            </div>
          </div>
      </footer>
